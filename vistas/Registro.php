		...
		<div class="login-page">
			...
			<div class="form">
				...
				<div class="input-group mb-0">
					<input id="CUIL" name="Cuil" type="text" maxlength="19" placeholder="Usuario" autocomplete="off" class="form-control"/>
				...
				<form class="input-group mb-0">
					<input id="Clave" name="Clave" type="password" maxlength="19" placeholder="Contraseña" autocomplete="off" class="form-control"/>
					<div class="input-group-append">
						<div class="input-group-text">
				...
				<form class="input-group mb-0">
					<input id="CClave" name="CClave" type="password" maxlength="19" placeholder="Confirmar contraseña" autocomplete="off" class="form-control"/>
					<div class="input-group-append">
						<div class="input-group-text">
							<span class="fas fa-lock"></span>
						</div>
